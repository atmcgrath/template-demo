---
title:  "Text and Images" # Replace this with the title of your project.
author: "Your Name"
...
permalink: /templates/basic-project/

header:
    teaser: /assets/images/orange-cat-example.jpg # The image you put here will appear as a teaser on the site's homepage.
    image: /assets/images/orange-cat-example.jpg  # Putting the path to an image here will add a header image.
...
---
<!-- 
{% include figure image_path="/assets/images/orange-cat-example.jpg" alt="An orange cat" caption="credit to Michael Sum on Unsplash" %} -->
